...
The parent adopted the isolated refinement after this report.
The [assessment](REPORT.md) records the final acceptance matrix and the repeated independent peer results.
...
| Native both-small | 37.327 | 36.275 | 37.412 | 36.831 |
...
| Coalesced both-small | 26.938 | 26.581 | 27.332 | 26.500 |
