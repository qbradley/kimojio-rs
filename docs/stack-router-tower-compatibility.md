...
| tower-http | compression | supported | `CompressionLayer` | `stateful_body_middleware_compression_updates_entity_headers_and_vary` | streaming compression deferred |
...
| tower-http | decompression | supported | `DecompressionLayer` | `stateful_body_middleware_decompression_rejects_oversized_decoded_bodies` | streaming decompression deferred |
