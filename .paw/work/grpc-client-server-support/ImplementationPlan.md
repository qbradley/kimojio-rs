...
- [ ] **Phase 1: Workspace, dependencies, and transport foundation** - Add crate scaffolding, selected runtime-agnostic dependencies, shared errors/config/body types, and plaintext/TLS transport boundaries.
